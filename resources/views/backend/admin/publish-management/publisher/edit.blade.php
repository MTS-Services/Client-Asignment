<x-admin::layout>
    <x-slot name="title">{{ __('Edit Publisher') }}</x-slot>
    <x-slot name="breadcrumb">{{ __('Edit Publisher') }}</x-slot>
    ...
    <section>
        <div class="glass-card rounded-2xl p-6 mb-6">
            <div class="flex items-center justify-between">
               ...
               <x-admin.primary-link href="{{ route('pm.publisher.index') }}">{{ __('Back') }} <i data-lucide="undo-2" class="w-4 h-4"></i>
