    ...
    <section>
        ...
        <div
            ...
            <div class="glass-card rounded-2xl p-6 md:col-span-5">
                <form action="{{ route('bm.book-issues.update', encrypt($issue->id)) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                <input type="decimal" name="fine_amount"
                                    value="{{ old('fine_amount', $issue->fine_amount) }}" class="flex-1" />
                            </label>
