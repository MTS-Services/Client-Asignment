    ...
    <section>
        ...
        <div
            ...
            <div class="glass-card rounded-2xl p-6 md:col-span-5">
                <form action="{{ route('bim.book-issues.update', encrypt($issue->id)) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div class="space-y-2 col-span-2">
                            ...
                            <textarea name="notes" rows="4" placeholder="Notes"
                                class="w-full dark:bg-slate-900 border-gray-300 dark:border-gray-600">{{ old('notes', $issue->notes) }}</textarea>
