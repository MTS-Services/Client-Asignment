        ...
        <div class="glass-card rounded-2xl p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <x-admin.primary-link secondary="true" href="{{ route('bm.category.trash') }}">{{ __('Trash') }} <i data-lucide="trash-2" class="w-4 h-4"></i>
                    </x-admin.primary-link>
                    <x-admin.primary-link href="{{ route('bm.category.create') }}">{{ __('Add') }} <i data-lucide="plus" class="w-4 h-4"></i>
                    </x-admin.primary-link>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                $(document).on('click', '.view', function() {
                    ...
                    showDetailsModal(route, id, '{{ __('Category Details') }}', details);
                });
            });
        </script>
    @endpush
