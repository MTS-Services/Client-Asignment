                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                ...
                                <input type="text" placeholder="Number of Rack" value="{{ old('rack_number') }}" name="rack_number"
                                    class="flex-1" />
                            </label>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                ...
                                <input type="text" placeholder="Location" value="{{ old('location') }}" name="location"
                                    class="flex-1" />
                            </label>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                ...
                                <input type="text" placeholder="Capacity" value="{{ old('capacity') }}" name="capacity"
                                    class="flex-1" />
                            </label>
