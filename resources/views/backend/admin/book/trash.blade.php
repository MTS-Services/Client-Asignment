<x-admin::layout>
    <x-slot name="title">{{ __('Trashed Book List') }}</x-slot>
    <x-slot name="breadcrumb">{{ __('Trashed Book List') }}</x-slot>
    ...
    <section>
        ...
        <div class="glass-card rounded-2xl p-6 mb-6">
           ...
           <x-admin.primary-link href="{{ route('book.index') }}">{{ __('Back') }} <i data-lucide="undo-2"
